...
relevance 2: "[[Daniel Dennett (丹尼特)]]"
disambiguation:
banner:
media:
---
...
- **Semantic Holism (語意整體論)**: 單一語句無法獨立被驗證，科學理論是作為一個整體面對經驗的檢驗。修改理論網路的任何部分都可能影響其他部分。
- **Indeterminacy of Translation (翻譯的不確定性)**: 基於行為證據，可以建立多種互不相容但同樣正確的翻譯手冊。意義並非客觀固定的實體。
